...
import { FunnyCoinWrapper } from '../lib/contracts/FunnyCoinWrapper';
...
export function App() {
    ...
    const [contract, setContract] = useState<FunnyCoinWrapper>();
    ...
    async function deployContract() {
        const _contract = new FunnyCoinWrapper(web3);
